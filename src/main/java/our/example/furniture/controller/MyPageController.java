...
public class MyPageController {
    ...
    public String myPage_CurrentView(@ModelAttribute("params") PostDTO params, HttpServletResponse response, HttpServletRequest request, Model model) {
    ...
    public String myPage_Dibs(@ModelAttribute("params") PostDTO params, HttpSession session, Model model) {
    ...
    public String myPage_UploadPost(@ModelAttribute("params") PostDTO params , HttpSession session, Model model) {
    ...
    public String myPage_UserInfoFix(UserRegisterDTO userRegisterDto, HttpSession session , Model model) {
    ...
    public String myPage_UserWithdrawal() {
